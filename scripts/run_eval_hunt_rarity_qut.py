...
def main() -> None:
    ...
    ap.add_argument("--val-list", type=str, default="splits_full/qut_train.txt")
    ...
    # For QUT we can afford broader etypes; keep grid modest.
    ap.add_argument("--etypes", type=str, default="ALL;NET_ONLY;NET_AND_CMD")
    ap.add_argument("--lambdas", type=str, default="0.1,0.3,0.5")
    ap.add_argument("--idf-caps", type=str, default="0,2,5")
    ap.add_argument("--dry-run", action="store_true", default=False)

    args = ap.parse_args()

    # Default filters tuned for QUT observation-noise.
    filter_args = (
