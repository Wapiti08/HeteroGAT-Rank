...
from comp.old_pipeline.comploss import CompositeLoss
...
# NOTE: Legacy model file intentionally contains **no** Accelerate/DDP logic.
# Training scripts may wrap this model with Accelerate externally if needed.
